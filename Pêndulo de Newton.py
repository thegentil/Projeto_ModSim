...
- Adicionamos um novo gráfico com os valores máximos de cada oscilação.
...
# Criando uma nova lista contendo os valores máximos de cada iteração
...
plt.plot(lt, lv,'r')     # Definindo quais variaveis serão plotados
plt.axis([0, max(lt), 0, 90])     # Definindo os valores máx e min a serem plotados
plt.ylabel('Ângulo (Em graus)')     # Definindo a label do eixo y
plt.xlabel('t')     # Definindo a label do eixo x
plt.title('Valores máx - Chumbo')     # Definindo o título
plt.show()     # Faz o gráfico
...
- Adicionamos um novo gráfico com os valores máximos de cada oscilação.
- Adicionamos um novo gráfico do tempo de estabilização pelo ângulo inicial
